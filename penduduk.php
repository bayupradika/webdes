...
<h2>C. Data Berdasarkan Pendidikan</h2>
    <table>
    <thead>
        <tr>
    ...
    <tbody>
        ...
        <tr>
            <td>Satpam/Security</td>
            <td>5 orang</td>
            <td>0 orang</td>
        </tr>
        <tr>
            <td><strong>Jumlah Total Penduduk</strong></td>
